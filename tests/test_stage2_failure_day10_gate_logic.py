...
def _passing_metrics():
    values = {
        ...
        "invalid_reset_raw_cusum_match": True,
        "invalid_reset_huber_cusum_match": True,
        "invalid_reset_sign_run_match": True,
        ...
        "frame_diagnostics_comparison_count": 1,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("day9_precondition_pass", False),
        ("head_descends_from_day9_checkpoint", False),
        ("non_oracle_method_list_pass", False),
        ...
        ("frame_diagnostics_failure_count", 1),
        ("frame_diagnostics_checksum_mismatch_count", 1),
        ("solver_failure_count_control", 1),
        ("solver_failure_count_variant_total", 1),
        ("strategy_mismatch_count", 1),
        ("failure_frame_record_mismatch_count", 1),
        ("filesystem_sandbox_pass", False),
        ("invalid_reset_huber_cusum_match", False),
        ("invalid_reset_sign_run_match", False),
