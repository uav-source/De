...
from zero_perturbation.backend_phase_a_metrics import OPEN3D_BACKEND


def test_runner_fixture_open3d_identity_passes(actual_fixture_run):
    row = actual_fixture_run["results"][OPEN3D_BACKEND]
