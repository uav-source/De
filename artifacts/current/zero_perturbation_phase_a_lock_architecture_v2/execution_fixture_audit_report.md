# Phase A Lock Architecture v2 Execution Audit
...
- Fresh/resumed trial counts: 6/6
- Resume skipped/reexecuted valid results: 2/0
- Exact mismatches: 0
- Numeric differences outside tolerance: 0
- Numeric differences inside tolerance: 0
- Maximum absolute numeric difference: 0.0 at `None`
- Analysis/verifier differences: 0
- Publisher tables/figures: 10/5
- Formal cache reads/backend executions/results: 0/0/0

`EXECUTION_FIXTURE_AUDIT_PASS = true`
