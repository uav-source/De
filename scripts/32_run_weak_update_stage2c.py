#!/usr/bin/env python3
"""Run Stage 2C quick, Development, lock, reserved Test, or analysis-only."""
...
from eval.weak_update_stage2c import (  # noqa: E402
    analyze_existing_stage2c,
    lock_update_analysis,
    run_weak_update_stage2c,
)
...
def main() -> int:
    ...
    if args.lock_update:
        ...
        print("committable update lock: artifacts/current/weak_update_stage2c/locked/update_lock.json")
