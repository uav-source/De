#!/usr/bin/env python3
"""Verify a compact Synthetic Confirmatory v3 JSON-native r3 artifact."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        report = verify_bootstrap_repair_r3_prerun_artifact(args.artifact)
    except BootstrapRepairR3ArtifactError as error:
        report = {
